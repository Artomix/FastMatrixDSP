...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=FastMatrix Demo Installer\n"
      else:
        line="OutputBaseFilename=FastMatrix Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the FastMatrix Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the FastMatrix installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=FastMatrix Demo installer\n"
     else:
       line="SetupWindowTitle=FastMatrix installer\n"
